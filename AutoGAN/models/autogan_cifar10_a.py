...
from AutoGAN.models.building_blocks import Cell, DisBlock, OptimizedDisBlock
...
class Generator(nn.Module):
    def __init__(self, args=None):
        ...
        #    nn.Tanh()
        #)
        self.l1 = nn.Linear(128, (self.bottom_width ** 2) * 256)
        self.cell1 = Cell(256, 256, 'nearest', num_skip_in=0, short_cut=True)
        self.cell2 = Cell(256, 256, 'bilinear', num_skip_in=1, short_cut=True)
        self.cell3 = Cell(256, 256, 'nearest', num_skip_in=2, short_cut=False)
        self.to_rgb = nn.Sequential(
            nn.BatchNorm2d(256),
            nn.ReLU(),
